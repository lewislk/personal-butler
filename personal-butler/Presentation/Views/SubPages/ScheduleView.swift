...
struct ScheduleView: View {
    ...
    private var monthView: some View {
        ...
        return VStack(spacing: 8) {
            let f = DateFormatter(); let _ = (f.locale = Locale(identifier: "zh_CN"))
            let title: String = {
...
struct CreateScheduleSheet: View {
    ...
    @State private var colorTag: ScheduleColorTag = .blue
        ...
        NavigationStack {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("保存") {
                        let e = ScheduleEvent(title: title.isEmpty ? "无标题" : title,
